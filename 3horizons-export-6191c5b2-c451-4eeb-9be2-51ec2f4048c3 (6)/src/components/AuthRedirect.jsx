...
const AuthRedirect = () => {
  ...
  useEffect(() => {
    const handleRedirect = async () => {
      ...
      // Part 1 Fix: Check if the user is a store owner by querying the stores table.
      ...
      // If no store record, they are a customer. Find their loyalty card.
      ...
      try {
        ...
        if (customerError || !customerData || !customerData.loyalty_cards || customerData.loyalty_cards.length === 0) {
          toast({
        ...
        const loyaltyCardId = customerData.loyalty_cards[0].id;
